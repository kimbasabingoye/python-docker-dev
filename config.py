...
POSTGRES_SERVER = os.getenv('POSTGRES_SERVER', 'Variable not set')
POSTGRES_USER = os.getenv('POSTGRES_USER', 'Variable not set')
POSTGRES_DB = os.getenv('POSTGRES_DB', 'Variable not set')
SECRET_FILE_PATH = os.getenv('POSTGRES_PASSWORD_FILE', 'Variable not set')
...
settings = Settings(POSTGRES_SERVER=POSTGRES_SERVER,
                    POSTGRES_USER=POSTGRES_USER,
                    POSTGRES_DB=POSTGRES_DB,
                    POSTGRES_PASSWORD_FILE=SECRET_FILE_PATH)
